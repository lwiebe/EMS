...
const EmployeeForm = ({ initialData, onSuccess, onCancel }) => {
  ...
  return (
    <from onSubmit={handleSubmit} className="space-y-6 max-w-3xl animate-fade-in">

      {/* Personal Information */}
      <div className="card p-5 sm:p-6">
        <h3 className="font-medium mb-6 pb-4 border-b border-slate-100">Personal Infromation</h3>
      ...
      {/* Account Setup */}
      <div className="card p-5 sm:p-6">
        <h3 className="font-base font-medium text-slate-900 mb-6 pb-4 border-b border-slate-100">Account Setup</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
          <div className="sm:col-span-2">
