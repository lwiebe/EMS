...
export const createEmployee = async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Failes to create employee" });
  }
}
...
export const updateEmployee = async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Failes to update employee" });
  }
}
...
export const deleteEmployee = async (req, res) => {
  try {
    ...
    return res.status(500).json({ error: "Failes to delete employee" });
  }
}